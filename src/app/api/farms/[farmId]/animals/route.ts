...
import {
    validateAnimalStatusTransition,
    validateEventCreation
} from '@/lib/middleware/business-validation'
...
export const POST = withErrorHandler(async (
    ...
    if (validatedData.type === 'INDIVIDUAL' && validatedData.lotCount) {
        throw new BusinessLogicError('Lot count should not be provided for individual animals', 'INDIVIDUAL_NO_LOT_COUNT')
    }
